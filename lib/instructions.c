...
instruction instructions[0x100] = {
    ...
    [0x28] = {IN_JR, AM_D8, RT_NONE, RT_NONE, CT_C},
    ...
    //TODO: CHECK REFERENCES IF THEY USE LDH INSTEAD OF LH FOR INSTRUCTIONS E & F A
    //0xE*
    ...
    [0xDF] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x28},
